	...
	private function createRepository(): void
	{
		$this->write(self::REPOSITORY, [
			'comments' => [
				...
				"@method $this->name createFromData({$this->setupProvider->getName(self::DATA_OBJECT)} \$data, ?$this->name \$original = null, ?Person \$person = null, ?DateTimeInterface \$date = null, bool \$fromNeon = false)",
			],

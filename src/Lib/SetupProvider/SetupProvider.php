...
class SetupProvider
{
	...
	public function getConfigDir(string $key): ?string
	{
		return match($key) {
			...
			BuildGenerator::TEMPLATE_FACTORY,
			BuildGenerator::MODEL,
			BuildGenerator::DATA_MODEL => BuildGenerator::CONFIG_DIR,
			...
			ModuleGenerator::MODEL_TRAIT,
			ModuleGenerator::DATA_MODEL_TRAIT,
			ModuleGenerator::DI_EXTENSION => ModuleGenerator::CONFIG_DIR,

			BuildModelGenerator::ENTITY,
			BuildModelGenerator::MAPPER,
			BuildModelGenerator::REPOSITORY,
			BuildModelGenerator::DATA_OBJECT,
			BuildModelGenerator::DATA_REPOSITORY => BuildModelGenerator::CONFIG_DIR,
			...
			ModelGenerator::DATA_OBJECT_TRAIT,
			ModelGenerator::DATA_REPOSITORY_TRAIT,
			ModelGenerator::CONVENTIONS => ModelGenerator::CONFIG_DIR,

			ComponentGenerator::TEMPLATE,
			ComponentGenerator::CONTROL,
			ComponentGenerator::FACTORY => ComponentGenerator::CONFIG_DIR,

			CommandGenerator::COMMAND => CommandGenerator::CONFIG_DIR,
			ServiceGenerator::SERVICE => ServiceGenerator::CONFIG_DIR,
	...
	{
		return __DIR__ . '/../../files/' . $this->getConfigDir($key) . "/$key.neon";
	}
